...
void actual_frequencies_update() {
  ...
  /*
  Serial.print("Ce que le pin where_led_bend reçoit :");
  Serial.println(constrain(map(an0, 0, 1023, 0, 255), 0, 255));
  */
  analogWrite(where_led_bend, constrain(map(an0, 0, 1023, -10, 255), 0, 255));
  if (mode == 1) {
    for (int i = 0; i < 20; i++) {
