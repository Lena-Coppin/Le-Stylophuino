...
//Programme uniquement sur les notes naturelles, possibilité de jouer les notes altérées avec l'appuie d'un bouton (but_alt) 
...
int but_alt = 10;   //NOTE + 1/2 ton
//int but_oct = 11;  //NOTE A L'OCTAVE
...
void setup()
{
  ...
  pinMode(but_alt, INPUT);
  pinMode(but_oct, INPUT);
...
void loop()
{
  ...
  int b_alt = digitalRead(but_alt);
  int b_oct = digitalRead(but_oct);
...
if (b_alt == 1){
  ...
  if( b1 == 1 ) {
    ...
    if((real_tension >= 0.35) && (real_tension < 0.8)){
      tone(buzzer, f+4);
      Serial.println("Modulation : 281 Hz");
      }
  
    if((real_tension >= 0.8) && (real_tension < 3)){
      tone(buzzer, f+8);
      Serial.println("Modulation : 285 Hz");
      }
        
    if((real_tension >= 3) && (real_tension < 4.8)){
      tone(buzzer, f+12);
      Serial.println("Modulation : 289 Hz");
      }
...
//b1=0
    ...
    if (b3 == 0){
      ...
      if (b5 == 0){
        ...
        if (b6 == 0){
          ...
          if (b8 == 0){
              ...
              if (b12 == 0){
                ...
                if (b13 == 0){
                 ...
                 if (b13 == 1){
                  ...
                  if((real_tension >= 0.35) && (real_tension < 0.8)){
                    tone(buzzer, f+8);
                    Serial.println("Modulation : 562 Hz");
                    }
                
                  if((real_tension >= 0.8) && (real_tension < 3)){
                    tone(buzzer, f+16);
                    Serial.println("Modulation : 570 Hz");
                    }
                      
                  if((real_tension >= 3) && (real_tension < 4.8)){
                    tone(buzzer, f+24);
                    Serial.println("Modulation : 578 Hz");
                    }
                
                  if((real_tension >= 4.8) && (real_tension <= 5)){
                    tone(buzzer, f+33);
                    Serial.println("RE4 : 587 Hz");
                    } 
                  }
                }
              }
            ...
            if (b10 == 1){
              ...
              if((real_tension >= 0.35) && (real_tension < 0.8)){
                tone(buzzer, f+7);
                Serial.println("Modulation : 473 Hz");
                }
            
              if((real_tension >= 0.8) && (real_tension < 3)){
                tone(buzzer, f+14);
                Serial.println("Modulation : 480 Hz");
                }
                  
              if((real_tension >= 3) && (real_tension < 4.8)){
                tone(buzzer, f+21);
                Serial.println("Modulation : 487 Hz");
                }
          ...
          if (b8 == 1){
            ...
            if((real_tension >= 0.35) && (real_tension < 0.8)){
              tone(buzzer, f+6);
              Serial.println("Modulation : 421 Hz");
              }
          
            if((real_tension >= 0.8) && (real_tension < 3)){
              tone(buzzer, f+12);
              Serial.println("Modulation : 427 Hz");
              }
                
            if((real_tension >= 3) && (real_tension < 4.8)){
              tone(buzzer, f+18);
              Serial.println("Modulation : 433 Hz");
              }
        ...
        if (b6 == 1){
          ...
          if(real_tension < 0.35){
            tone(buzzer, f);
            Serial.println("FA3# : 370 Hz");
            }
        
          if((real_tension >= 0.35) && (real_tension < 0.8)){
            tone(buzzer, f+5);
            Serial.println("Modulation : 375 Hz");
            }
        
          if((real_tension >= 0.8) && (real_tension < 3)){
            tone(buzzer, f+10);
            Serial.println("Modulation : 380 Hz");
            }
              
          if((real_tension >= 3) && (real_tension < 4.8)){
            tone(buzzer, f+15);
            Serial.println("Modulation : 385 Hz");
            }
  ...
  if ( b3 == 1 ){
    ...
    if((real_tension >= 0.35) && (real_tension < 0.8)){
      tone(buzzer, f+5);
      Serial.println("Modulation : 316 Hz");
      }
  
    if((real_tension >= 0.8) && (real_tension < 3)){
      tone(buzzer, f+10);
      Serial.println("Modulation : 321 Hz");
      }
        
    if((real_tension >= 3) && (real_tension < 4.8)){
      tone(buzzer, f+15);
      Serial.println("Modulation : 326 Hz");
      }
